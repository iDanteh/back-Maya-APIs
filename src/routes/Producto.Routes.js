...
import { buscarProductos, getProductos, getProductosById, createProducto, updateProducto, deleteProduct, restoreProduct } from '../controllers/Producto.Controllers.js'
import { verifyToken } from '../middlewares/auth.js';

const router = Router();

router.get('/api/v1/productos',          getProductos);
router.get('/api/v1/productos/buscar',   buscarProductos);
